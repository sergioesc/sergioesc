...
export default function OrderScreen() {
  ...
  //Aca igualamos el "order/:id" del App.js con el parametro obtenido del token
  ...
  function createOrder(data, actioins) {
    return actioins.order
      .create({
        purchase_units: [
          {
  ...
  function onApprove(data, actions) {
    return actions.order.capture().then(async function (details) {
      try {
        ...
        toast.success("El pago se realizo con exito!");
      } catch (err) {
